...
namespace faint{
  ...
  faint::Bitmap alpha_blended( const Bitmap&, const Color& );
  ...
  void draw_dumb_ellipse( Bitmap&, const IntRect&, const Color& );
  void draw_ellipse( Bitmap&, const IntRect&, int lineWidth, const Color&, bool dashes );
  ...
  faint::Bitmap flip( const Bitmap&, Axis::type );
  ...
  faint::Bitmap rotate( const Bitmap&, radian angle, const Color& background );
  faint::Bitmap rotate_90cw( const Bitmap& );
  faint::Bitmap scale( const Bitmap&, const Scale&, ScaleQuality::type );
  faint::Bitmap scaled_subbitmap( const Bitmap&, const Scale&, const IntRect& );
  faint::Bitmap scale_bilinear( const Bitmap&, const Scale& );
  faint::Bitmap scale_nearest( const Bitmap&, int scale );
  faint::Bitmap scale_nearest( const Bitmap&, const Scale& );
