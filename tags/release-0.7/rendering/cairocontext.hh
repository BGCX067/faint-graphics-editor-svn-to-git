...
faint::Bitmap cairo_compatible_bitmap( const IntSize& );
faint::Bitmap cairo_compatible_sub_bitmap( const Bitmap&, const IntRect& );
faint::Bitmap cairo_skew( Bitmap& bmp, faint::coord skew, faint::coord skew_pixels );
...
public:
  ...
  std::vector<int> partial_extents( const utf8_string&, const Settings&) const;
  void restore();
