...
def build():
    ...
    if len(to_compile) > 0:
        compile( to_compile, faintRoot, include, out, err, objRoot, wx_root, rvalue_ref=rvaluerefs, version=opts.version, debug=opts.debug, num_parallell=parallell_compiles )
