...
bool SelectText::Draw( FaintDC& dc, Overlays& overlays, const Point& ){
...
bool SelectText::DrawBeforeZoom(Layer::type layer) const{
...
Cursor::type SelectText::GetCursor( const CursorPositionInfo& ) const{
  return Cursor::CARET;
}
