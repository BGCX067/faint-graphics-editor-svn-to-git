...
#ifndef FAINT_SETFLOATINGSELECTION_HH
#define FAINT_SETFLOATINGSELECTION_HH
...
public:
  SetRasterSelection(const RasterSelectionState& newState, const RasterSelectionState& oldState, const std::string& name );
...
public:
  SetSelectionOptions(const RasterSelectionOptions& newOptions, const RasterSelectionOptions& oldOptions);
  void Do( CommandContext& );
  std::string Name() const;
  void Undo( CommandContext& );
private:
