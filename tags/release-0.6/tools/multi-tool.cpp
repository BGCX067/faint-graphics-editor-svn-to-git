...
MultiTool::MultiTool( ToolId id, SettingNotifier& notifier, bool eatsSettings, default_task defaultTask, initial_task initialTask)
  : Tool(id, notifier, eatsSettings),
    m_task(defaultTask, initialTask)
{}
