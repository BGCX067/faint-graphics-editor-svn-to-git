...
public:
  void Notify( const BoolSetting&, bool );
  void Notify( const IntSetting&, int );
  void Notify( const StrSetting&, const std::string& );
  void Notify( const ColorSetting&, const faint::Color& );
  void Notify( const FloatSetting&, FloatSetting::ValueType );
private:
