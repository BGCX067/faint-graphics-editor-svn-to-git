...
// Returns CMD_TYPE_RASTER if all commands are raster,
// CMD_TYPE_OBJECT if all are object or HYBRID if any is hybrid
// or there are both object and raster commands.
...
Command* get_selection_rectangle_command( const IntRect&, const RasterSelectionOptions&, const RasterSelectionState& oldState);
