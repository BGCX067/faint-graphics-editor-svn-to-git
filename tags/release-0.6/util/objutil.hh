...
void get_attach_points( const Tri&, const objects_t& );
...
// imagePos is outside the object.
// Ignores masking, so if imagePos falls on a region in the object
// which is transparent due to being the masked background color, the
// color will still be returned.
