...
class Histogram;
typedef Unique<int, Histogram, 0> bin_t;
typedef Unique<int, Histogram, 1> count_t;

class Histogram{
public:
  Histogram( const ClosedIntRange& range, const bin_t& numBins );
