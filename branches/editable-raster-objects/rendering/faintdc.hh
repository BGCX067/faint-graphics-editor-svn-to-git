...
public:
  ...
  void Ellipse( const Tri&, const Filter&, const Settings& );
  faint::Color GetPixel( const Point& ) const;
  void Line( const Point&, const Point&, const Filter&, const Settings& );
  ...
  void Rectangle( const Tri&, const Filter&, const Settings& );
  ...
  Size TextSize( const faint::utf8_string&, const Settings& ) const;
  TextMeasures<Rect> TextExtents( const faint::utf8_string&, const Settings& ) const;
  std::vector<int> CumulativeTextWidth( const faint::utf8_string&, const Settings& ) const;
private:
