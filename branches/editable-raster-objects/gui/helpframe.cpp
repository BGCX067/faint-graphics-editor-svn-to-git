...
public:
  ...
  wxTreeItemId AddChildPage( const wxTreeItemId& parent, const std::string& title, const page_filename& page ){
...
public:
  HelpFrameImpl(const std::string& rootDir, const ArtContainer& art)
...
HelpFrame::HelpFrame(const std::string& rootDir, const ArtContainer& art){
  m_impl = new HelpFrameImpl(rootDir, art);
}
