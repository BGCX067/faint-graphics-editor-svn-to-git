...
#ifndef FAINT_AUTOCROP_HH
#define FAINT_AUTOCROP_HH
...
bool get_auto_crop_rect( const faint::Bitmap&, IntRect& result );
...
std::vector<IntRect> get_auto_crop_rectangles( const faint::Bitmap& );
...
Optional<faint::Color> get_edge_color( const faint::Bitmap&, const IntRect& );

bool get_bottom_edge_color( const faint::Bitmap&, faint::Color& result );
bool get_left_edge_color( const faint::Bitmap&, faint::Color& result );
bool get_right_edge_color( const faint::Bitmap&, faint::Color& result );
bool get_top_edge_color( const faint::Bitmap&, faint::Color& result );
