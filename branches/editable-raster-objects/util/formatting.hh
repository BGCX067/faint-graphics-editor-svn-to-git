...
std::string str_axis_adverb( Axis );
std::string str_degrees( faint::degree );
std::string str_degrees_int( int );
std::string str( const faint::DrawSource& );
std::string str_center_radius( const Point&, faint::coord r );
std::string str_center_radius( const Point&, const Radii& );
...
std::string str_interval( const Interval& );
std::string str_int_length( int );
std::string str_length( faint::coord );
std::string str_line_status( const IntPoint&, const IntPoint& );
std::string str_line_status_subpixel( const Point&, const Point& );
std::string str_range( const ClosedIntRange& );

// Excludes the alpha-component if fully opaque
std::string str_smart_rgba(const faint::Color&);

class category_formatting;
typedef Unique<bool, category_formatting, 0> rgb_prefix;
std::string str_smart_rgba(const faint::Color&, const rgb_prefix& );
...
extern const Join endline_sep;
extern const Join no_sep;
