...
public:
  RasterSelectionOptions( bool mask, const faint::DrawSource& bg, bool alpha );
  bool alpha;
  faint::DrawSource bg;
  bool mask;
};
...
public:
  ...
  const faint::DrawSource& GetBackground() const;
  ...
  void SetBackground( const faint::DrawSource& );
  ...
  // Must be Floating(). Part of the RasterSelection since this requires both the
  // state and options
...
void update_mask( bool enableMask, const faint::DrawSource& bg, bool enableAlpha, RasterSelection& );
