...
public:
  ...
  virtual void Load( const faint::FilePath& filename, ImageProps& ) = 0;
  virtual SaveResult Save( const faint::FilePath&, CanvasInterface& ) = 0;
private:
  bool m_canLoad;
  bool m_canSave;
  std::vector<std::string> m_extensions; // Fixme: Use extension class
  std::string m_label;
};
