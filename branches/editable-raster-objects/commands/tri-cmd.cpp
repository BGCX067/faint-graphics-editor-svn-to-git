...
TriCommand::TriCommand( Object* object, const NewTri& newTri, const OldTri& oldTri, const std::string& name, MergeMode mergeMode )
...
bool TriCommand::Merge( Command* cmd ){
  if ( !m_mergable ){
    return false;
  }
