...
#ifndef FAINT_SELECTION_IDLE_HH
#define FAINT_SELECTION_IDLE_HH
#include "tasks/raster-selection-task.hh"

class SelectionIdle : public RasterSelectionTask {
public:
  SelectionIdle(Settings&);
...
private:
  SelectionIdle& operator=(const SelectionIdle&); // Prevent assignment
