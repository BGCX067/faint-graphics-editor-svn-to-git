...
void MoveSelection::Draw( FaintDC&, Overlays&, const Point& ){
}

bool MoveSelection::DrawBeforeZoom(Layer) const{
  return false;
}

Cursor MoveSelection::GetCursor(const CursorPositionInfo& ) const{
  return Cursor::MOVE;
}
