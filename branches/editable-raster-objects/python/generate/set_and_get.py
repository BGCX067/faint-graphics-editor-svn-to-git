...
setters_and_getters = {
    ...
    "ts_BrushShape" : StringToInt(
        ...
        cpp_enum=CppEnum("BrushShape", entries=("SQUARE", "CIRCLE"))),
    ...
    "ts_FillStyle" : StringToInt(
        ...
        cpp_enum=CppEnum("FillStyle", entries=("BORDER", "BORDER_AND_FILL", "FILL"))),
    ...
    "ts_FgCol" : Color("ts_FgCol", "fg", "Foreground Color", "Foreground color."),
    "ts_BgCol" : Color("ts_BgCol", "bg", "Background Color", "Background color."),
