...
MouseCapture::MouseCapture(wxWindow* w, const std::function<void()>& onLoss, const std::function<void()>& onRelease)
  : m_onCaptureLost(onLoss),
    m_onRelease(onRelease),
    m_window(w)
{
  w->Bind(wxEVT_MOUSE_CAPTURE_LOST,
...
void MouseCapture::OnCaptureLost(){
