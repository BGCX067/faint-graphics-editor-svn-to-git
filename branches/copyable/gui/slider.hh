...
wxDECLARE_EVENT(EVT_FAINT_SLIDER_CHANGE, SliderEvent);
...
Slider* create_slider(wxWindow*, const BoundedInt&, SliderDir, const SliderMarker&, const SliderBackground&);
Slider* create_slider(wxWindow*, const BoundedInt&, SliderDir, const SliderBackground&);
