...
public:
      ...
      m_feedback(feedback)
  {
    ...
    m_pinchSlider = create_slider(this, BoundedInt::Mid(min_t(-100), max_t(100)), SliderDir::HORIZONTAL, SliderRectangleBackground());
    m_pinchSlider->SetInitialSize(wxSize(200,20));

    auto lblWhirl = label(this, "Whirl");
    m_whirlSlider = create_slider(this, BoundedInt::Mid(min_t(-360), max_t(360)), SliderDir::HORIZONTAL, SliderRectangleBackground());
...
private:
  ...
  void UpdatePreview(){
    ...
    filter_pinch_whirl(bmp2, GetPinchValue(), GetWhirlValue());
