...
static void line_status_bar(StatusInterface& status, const LineSegment& line, const ToolModifiers& modifiers, bool subPixel){
...
static faint::coord refresh_width(const Settings& s){
...
class LineTool : public StandardTool{
public:
...
private:
  ...
  Command* CreateCommand(Layer layer){
    ...
    return add_or_draw(create_line_object(Points(points),
