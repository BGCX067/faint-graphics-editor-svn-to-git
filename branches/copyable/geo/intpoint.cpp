...
IntPoint max_coords(const IntPoint& a, const IntPoint& b, const IntPoint& c){
  return IntPoint(std::max(std::max(a.x, b.x), c.x), std::max(std::max(a.y, b.y),c.y));
}
...
IntPoint min_coords(const IntPoint& a, const IntPoint& b, const IntPoint& c){
  return IntPoint(std::min(std::min(a.x, b.x), c.x), std::min(std::min(a.y, b.y),c.y));
}
