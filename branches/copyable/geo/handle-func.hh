...
template<> struct handle_return<Handle::P0>{typedef Point type;};
template<> struct handle_return<Handle::P1>{typedef Point type;};
template<> struct handle_return<Handle::P2>{typedef Point type;};
template<> struct handle_return<Handle::P3>{typedef Point type;};
template<> struct handle_return<Handle::P0P1>{typedef LineSegment type;};
template<> struct handle_return<Handle::P0P2>{typedef LineSegment type;};
template<> struct handle_return<Handle::P1P3>{typedef LineSegment type;};
template<> struct handle_return<Handle::P2P3>{typedef LineSegment type;};
