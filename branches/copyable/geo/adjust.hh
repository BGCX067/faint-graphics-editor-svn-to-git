...
Point adjust_to(const Point& origin, const Point&, const Rotation& step, const Rotation& offset);
...
Point adjust_to_default(const Point& origin, const Point&, const Angle&, const Angle& altAngle);
