...
public:
  ...
  void Draw(FaintDC& dc){
    ...
    dc.Text(tri_from_rect(Rect(p0, Size(100,20))), utf8_string("p0="), txtSettings);
    dc.Text(tri_from_rect(Rect(p1, Size(100,20))), utf8_string("p1="), txtSettings);
    dc.Text(tri_from_rect(Rect(p2, Size(100,20))), utf8_string("p2="), txtSettings);
    dc.Text(tri_from_rect(Rect(p3, Size(100,20))), utf8_string("p3="), txtSettings);

    Rect r(bounding_rect(tri));
    dc.Text(tri_from_rect(Rect(r.TopRight() + Point(10,0), Size(100,100))), utf8_string("w="), txtSettings);
  }
