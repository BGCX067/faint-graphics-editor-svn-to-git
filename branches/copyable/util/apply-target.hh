...
auto dispatch_target(ApplyTarget t, OBJECTF objectFunc, RASTERF rasterFunc, IMAGEF imageFunc) -> decltype(objectFunc(OBJECT_SELECTION())){
  switch(t){
...
Size get_apply_target_size(const Canvas&, ApplyTarget);
