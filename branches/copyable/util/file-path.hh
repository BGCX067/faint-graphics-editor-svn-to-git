...
public:
  ...
  ~FileExtension();
  faint::utf8_string Str() const;

  bool operator==(const FileExtension&) const;
  FileExtension& operator=(const FileExtension&) = delete;
private:
...
public:
  ...
  FilePath File(const faint::utf8_string& ) const;
  faint::utf8_string Str() const;
...
private:
  ...
  typedef std::vector<FilePath*>::const_iterator iter_type;
