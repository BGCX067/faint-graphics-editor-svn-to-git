...
typedef Distinct<bool,RasterSelection,0> copy_selected;
...
typedef Order<SelectionOptions>::New NewSelectionOptions;
typedef Order<SelectionOptions>::Old OldSelectionOptions;
...
public:
  ...
  // Fixme: Add e.g. implicitly copyable bitmap instead
  // of hand-written constructor.
  SelectionState(const SelectionState& other)
    : copy(other.copy),
      floating(other.floating),
      floatingBmp(faint::copy(other.floatingBmp)),
      oldRect(other.oldRect),
      rect(other.rect)
  {}
...
typedef Order<SelectionState>::New NewSelectionState;
typedef Order<SelectionState>::Old OldSelectionState;
...
namespace sel{
  ...
  public:
    explicit Moving(const IntRect&, const IntRect&, const Bitmap&, const SelectionOptions&);
...
void update_mask(bool enableMask, const Paint& bg, bool enableAlpha, RasterSelection&);
