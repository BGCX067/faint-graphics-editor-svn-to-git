...
// FrameProps& ImageProps::AddFrame(const Bitmap& bmp, const FrameInfo& info){
//   m_frames.push_back(FrameProps(bmp, info));
//   return m_frames.back();
// }
...
int ImageProps::GetNumFrames() const{
  return resigned(m_frames.size());
}
