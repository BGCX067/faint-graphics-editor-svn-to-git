...
utf8_string get_collective_name(const objects_t&);
...
Point snap(const Point&, const objects_t&, const Grid&, coord maxDistance=g_maxSnapDistance);
Point snap(const Point&, const objects_t&, const Grid&, const std::vector<Point>& extraPoints, coord maxDistance=g_maxSnapDistance);
coord snap_x(coord x, const objects_t&, const Grid&, coord y0, coord y1, coord maxDistance=g_maxSnapDistance);
coord snap_y(coord y, const objects_t&, const Grid&, coord x0, coord x1, coord maxDistance=g_maxSnapDistance);
