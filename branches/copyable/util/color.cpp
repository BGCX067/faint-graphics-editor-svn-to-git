...
static unsigned int to_uint( const faint::Color& c ){
  using faint::uint;
...
namespace faint {
  ...
  ColRGB invert(const ColRGB& c){
    ...
    faint::uchar r = static_cast<faint::uchar>(255 - c.r);
    faint::uchar g = static_cast<faint::uchar>(255 - c.g);
    faint::uchar b = static_cast<faint::uchar>(255 - c.b);
    return ColRGB(r,g,b);
  }
...
Color subtract(const Color& lhs, const Color& rhs){
  ...
  return color_from_ints(r, g, b, 255);
}
