...
public:
  TextEntryCommand(ObjText* textObj, const NewText& newText, const OldText& oldText)
...
Command* text_entry_command(ObjText* obj, const NewText& newText, const OldText& oldText){
