...
class BitmapCommand{
  // A limited command-variant, unrelated to Command.
  // Only allowed to change the pixel content of a bitmap.
public:
  virtual ~BitmapCommand(){}
  virtual faint::utf8_string Name() const = 0;
  virtual void Do(faint::Bitmap&) = 0;
};
