...
typedef Distinct<utf8_string, category_command_bunch, 0> bunch_name;
...
Command* command_bunch(CommandType, const bunch_name&, const commands_t&, MergeCondition* c=nullptr);
Command* command_bunch(CommandType, const bunch_name&, const std::deque<Command*>&);

Command* command_bunch(CommandType, const bunch_name&, Command*, MergeCondition* c=nullptr);

Command* command_bunch(CommandType, const bunch_name&, Command*, Command*, MergeCondition* c=nullptr);
