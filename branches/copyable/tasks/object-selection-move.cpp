...
public:
  MoveObjectTask(Object* mainObject, const objects_t& allObjects, const Point& offset, MoveMode mode)
...
Task* move_object_task(Object* mainObject, const objects_t& allObjects, const Point& offset, MoveMode mode){
