...
typedef Distinct<bool, FaintInstance, 10> allow_start;
...
FaintInstance* create_faint_instance(const FileList& cmdLineFiles, const allow_server& allowServer, const force_start& forceStart, const std::string& port){
