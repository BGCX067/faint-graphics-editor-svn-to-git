...
def gen_makefile(fileList, opts, debug, cc):
    ...
    if debug:
        makefile.write("CCFLAGS=-Wall -Wextra -Werror -pedantic -ansi -Wconversion -Wno-strict-aliasing -std=c++11 -g -c\n")
    else:
        makefile.write("CCFLAGS=-Wall -Wextra -Werror -pedantic -ansi -Wconversion -O2 -Wno-strict-aliasing -std=c++11 -Wunused -fdiagnostics-show-option -c\n")
