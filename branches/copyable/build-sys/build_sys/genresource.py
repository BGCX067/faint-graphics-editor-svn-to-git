...
def _need_generate(paths):
    ...
    # Use the index file to determine if regeneration necessary
...
def _write_load_function(paths):
    ...
    cpp_file.write('#include "util/art-container.hh"\n')
    cpp_file.write('#include "util/file-path-util.hh"\n')
    cpp_file.write('\n')
    cpp_file.write('namespace faint{\n')
    cpp_file.write('void load_faint_resources( faint::ArtContainer& art ) {\n')
    cpp_file.write('  art.SetRoot( get_data_dir().SubDir("graphics") );\n')
    ...
    hh_file.write('void load_faint_resources( faint::ArtContainer& );\n')
    hh_file.write('}\n')
    hh_file.write('#endif\n')
