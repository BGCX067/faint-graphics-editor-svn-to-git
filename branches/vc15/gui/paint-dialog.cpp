...
public:
    ...
    : wxDialog(parent, wxID_ANY, title)
  {
    ...
    m_panelGradient = std::make_unique<PaintPanel_Gradient>(m_tabs, statusInfo,
      dialogContext);
...
static std::unique_ptr<PaintPanel_HSL> init_color_dialog_panel(wxPanel* bgPanel){
...
public:
    ...
    : wxDialog(parent, wxID_ANY, title)
  {
    ...
    sizer->Add(bg);
    m_panelHSL = init_color_dialog_panel(bg);
