...
const wxEventTypeTag< SettingEvent<IntSetting> > EVT_FAINT_INT_SETTING_CHANGE(FAINT_INT_SETTING_CHANGE);

const wxEventType FAINT_FLOAT_SETTING_CHANGE = wxNewEventType();
const wxEventTypeTag< SettingEvent<FloatSetting> > EVT_FAINT_FLOAT_SETTING_CHANGE(FAINT_FLOAT_SETTING_CHANGE);

const wxEventType FAINT_BOOL_SETTING_CHANGE = wxNewEventType();
const wxEventTypeTag< SettingEvent<BoolSetting> > EVT_FAINT_BOOL_SETTING_CHANGE(FAINT_BOOL_SETTING_CHANGE);

const wxEventType FAINT_COLOR_SETTING_CHANGE = wxNewEventType();
const wxEventTypeTag< SettingEvent<ColorSetting> > EVT_FAINT_COLOR_SETTING_CHANGE(FAINT_COLOR_SETTING_CHANGE);
...
const wxEventTypeTag<SettingsEvent> EVT_FAINT_SETTINGS_CHANGE(FAINT_SETTINGS_CHANGE);
