...
IntSettingCtrl* new_int_spinner(wxWindow* parent,
  const wxSize&,
  const IntSetting&,
  int value,
  const std::string& label);

FloatSettingControl* new_float_spinner(wxWindow* parent,
  const wxSize& size,
  const FloatSetting&,
  coord value,
  const std::string&);
...
FloatSettingControl* new_semi_float_spinner(wxWindow* parent,
  const wxSize& size,
  const FloatSetting&,
  coord value,
  const std::string&);
