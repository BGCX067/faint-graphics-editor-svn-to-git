...
// Returns a new ResizeDialogOptionss based on the passed in,
// with the given items replaced as specified.
ResizeDialogOptions modified(const ResizeDialogOptions&,
  bool scaleOnly,
  bool bilinearOnly);
