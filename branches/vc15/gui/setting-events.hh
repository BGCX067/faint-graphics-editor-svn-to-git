...
extern const wxEventTypeTag< SettingEvent<IntSetting> > EVT_FAINT_INT_SETTING_CHANGE;

extern const wxEventType FAINT_FLOAT_SETTING_CHANGE;
extern const wxEventTypeTag< SettingEvent<FloatSetting> > EVT_FAINT_FLOAT_SETTING_CHANGE;

extern const wxEventType FAINT_BOOL_SETTING_CHANGE;
extern const wxEventTypeTag< SettingEvent<BoolSetting> > EVT_FAINT_BOOL_SETTING_CHANGE;

extern const wxEventType FAINT_COLOR_SETTING_CHANGE;
extern const wxEventTypeTag< SettingEvent<ColorSetting> > EVT_FAINT_COLOR_SETTING_CHANGE;
