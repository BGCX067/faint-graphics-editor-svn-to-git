...
public:
      ...
      m_updateOnTree(true)
  {
    ...
    Bind(EVT_FAINT_SCROLL_HELP_END,
      [this](wxEvent&){
        m_html->FaintEnd();
      });

    Bind(EVT_FAINT_SCROLL_HELP_HOME,
      [this](wxEvent&){
        m_html->FaintHome();
      });

    Bind(EVT_FAINT_SCROLL_HELP_LINE_DOWN,
      [this](wxEvent&){
        if (m_tree->HasFocus()){
    ...
    Bind(EVT_FAINT_SCROLL_HELP_LINE_UP,
      [this](wxEvent&){
        if (m_tree->HasFocus()){
          m_html->FaintLineUp();
        }
    ...
    Bind(EVT_FAINT_SCROLL_HELP_PAGE_DOWN,
      [this](wxEvent&){
        m_html->FaintPageDown();
      });

    Bind(EVT_FAINT_SCROLL_HELP_PAGE_UP,
      [this](wxEvent&){
        m_html->FaintPageUp();
      });
