...
wxButton* noiseless_button(wxWindow* parent, const wxBitmap& bmp,
  const tooltip_t& tooltip, const wxSize& size)
{
...
LambdaAcceleratorEntry::LambdaAcceleratorEntry(const KeyPress& key,
...
void set_accelerators(wxWindow* window,
  const std::vector<LambdaAcceleratorEntry>& entries)
{
  std::vector<wxAcceleratorEntry> wx_entries;
