...
def gen_makefile(fileList, opts, debug, cc):
    ...
    if debug:
        makefile.write("CCFLAGS=-Wall -Wextra -Werror -pedantic -ansi -Wconversion -Wno-strict-aliasing -Wno-sign-conversion -std=c++14 -g -c\n")
    else:
        makefile.write("CCFLAGS=-Wall -Wextra -Werror -pedantic -ansi -Wconversion -O2 -Wno-sign-conversion -Wno-strict-aliasing -std=c++14 -Wunused -fdiagnostics-show-option -c\n")
