...
public:
  ImageTableImpl(const std::string& pageTitle,
    const std::string& heading0,
    const std::string& heading1,
    const std::string& heading2)
  {
    m_columnHeadings.emplace_back(heading0);
    m_columnHeadings.emplace_back(heading1);
    m_columnHeadings.emplace_back(heading2);
...
ImageTable::ImageTable(const std::string& title, const std::string& heading0, const std::string& heading1, const std::string& heading2 ){
  m_impl = new ImageTableImpl(title, heading0, heading1, heading2);
}

ImageTable::ImageTable(const std::string& title, const std::vector<utf8_string>& headings){
