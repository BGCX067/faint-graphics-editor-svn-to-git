...
// Copies the passed in bitmap to the clipboard. Returns the
// background color, which is used for alpha replacement when pasting
// outside Faint (if a color), and should be used to erase the hole
// left by a moved selection.
