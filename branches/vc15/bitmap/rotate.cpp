...
RotationAdjustment get_rotation_adjustment(const Angle& angle, const IntSize& size){
...
Bitmap rotate_nearest(const Bitmap& bmp, const Angle& angle, const Color& bgColor) {
  // Use the upper-left corner as pivot
  double CtX = 0;
  double CtY = 0;
