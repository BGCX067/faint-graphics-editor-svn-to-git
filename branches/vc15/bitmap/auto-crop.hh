...
// Returns an intrect bounding all pixels of the specified color,
// or nothing if the color is not found.
...
// Overload for optional bitmap. Return empty vector if optional not
// set.
