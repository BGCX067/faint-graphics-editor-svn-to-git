...
#include <cassert>
#include <climits> // C++11 (VC): For LONG_MAX, std::numeric_limits<int>::max() is not compile-time without constexpr. Not fixed yet in VC2015 preview.
...
class Interval{
  // An closed interval of integers, [Lower(), Upper()]
public:
...
using LowerBoundedInt = StaticBoundedInt<MIN_BOUND, LONG_MAX>;
...
public:
  ...
  static_assert(MIN_BOUND < MAX_BOUND, "Invalid template range for BoundedInterval");
