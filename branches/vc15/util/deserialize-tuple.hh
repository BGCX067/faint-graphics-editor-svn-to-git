...
struct deserializer{
    ...
    size_t byteOffset)
  {
    ...
    deserializer<N - 1, Head, Tail...>::add_rest(t, a, byteOffset + sizeof(item));
  }
};
...
template<class Head, class... Tail>
void deserialize_tuple(std::tuple<Head, Tail...>& t, const std::array<unsigned char, sizeof_entries<Head, Tail...>::value>& a){
...
TUPLE deserialize_tuple2(const ARRAY& a){
  TUPLE t;
