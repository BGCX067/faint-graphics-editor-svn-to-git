...
static utf8_string get_command_name(Command& cmd, const Image& targetFrame, const ImageList& frames){
...
void CommandHistory::Redo(TargetableCommandContext& cmdContext, const CanvasGeo& geo, ImageList& images){
  if (m_redoList.empty()){
    return;
  }
