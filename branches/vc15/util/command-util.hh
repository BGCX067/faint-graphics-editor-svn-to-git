...
Command* get_insert_raster_bitmap_command(const Bitmap&, const IntPoint&,
  const RasterSelection& oldSelection, const Settings&,
...
Command* get_scale_raster_selection_command(const Image&, const IntSize&, ScaleQuality);
