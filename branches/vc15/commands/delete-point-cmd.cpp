...
public:
  DeletePointCommand(Object* object, int pointIndex)
...
Command* delete_point_command(Object* object, int pointIndex){
  return new DeletePointCommand(object, pointIndex);
}
