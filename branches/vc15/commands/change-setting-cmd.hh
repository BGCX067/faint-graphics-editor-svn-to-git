...
public:
  ChangeSettingCommand(Object* object, const T& setting, const typename T::ValueType& value)
...
template<typename T>
ChangeSettingCommand<T>* change_setting_command(Object* obj, const T& setting, const typename T::ValueType& value){
