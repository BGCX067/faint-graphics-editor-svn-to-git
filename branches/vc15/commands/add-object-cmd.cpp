...
public:
  AddObjectCommand(Object* object, const select_added& select, const utf8_string& name, int z)
...
Command* add_object_command(Object* obj, const select_added& selectAdded, const utf8_string& name){
  return new AddObjectCommand(obj, selectAdded, name, -1);
}

Command* add_object_command(Object* obj, const select_added& selectAdded, int z, const utf8_string& name){
  assert(z >= -1);
