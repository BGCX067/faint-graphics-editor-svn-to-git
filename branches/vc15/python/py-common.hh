...
template<typename T>
void Common_replace_color(T target, const Color& oldColor, const Paint& replacement){
  python_run_command(target,
...
template<typename T>
void Common_rotate(T target, const radian& angle, const Optional<Paint>& bg){
  python_run_command(target,
...
omitted)." */
template<typename T>
void Common_set_threshold(T target, const threshold_range_t& range, const Optional<Paint>& paintIn, const Optional<Paint>& paintOut){
  python_run_command(target,
...
template<typename T>
void Common_erase_but_color(T target, const Color& keep, const Optional<Paint>& eraser){
  if (!eraser.IsSet()){
...
template<typename T>
void Common_color_balance(T target, const color_range_t& r, const color_range_t& g, const color_range_t& b){
  python_run_command(target,
