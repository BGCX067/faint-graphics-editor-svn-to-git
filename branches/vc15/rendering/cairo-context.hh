...
public:
  ...
  void arc(const Point& center, coord r, coord angle1, coord angle2);
  void arc_negative(const Point& center, coord r, coord angle1, coord angle2);
...
int get_font_ascent(const Settings&);
