...
utf8_string str_user(const index_t&);

// Returns the index zero-based as a string.
utf8_string str_coder(const index_t&);
...
utf8_string str_float(int precision, coord value);
...
utf8_string str_int_lpad(int, int w);
